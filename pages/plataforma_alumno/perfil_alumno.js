...
export default function Platform () {
    return (
        ...
        <Navegation user="Ramiro" name="Juan Rodriguez" title="Alumno 6to E.S.B" link1="/plataforma_alumno/panel_de_alumno" link2="/plataforma_alumno/swiper" link3="/plataforma_alumno/soporte_alumno" link4="/plataforma_alumno/calendario"/>        
        </div>
