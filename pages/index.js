...
export default function Home() {
  return (
    <main >
      ...
      <div className="bg-[url('/images/fondoSQ.png')] bg-cover bg-no-repeat flex justify-center items-center min-h-screen overflow-hidden" id="sabiasque">
        <div className="p-6 sm:p-12 max-w-screen-2xl w-full">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-[#0082D6]">
            ¿Sabías qué?
          </h1>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pt-8">
            <p className="text-white text-lg sm:text-xl md:text-2xl pr-0 lg:pr-20">
      ...
      <div className="bg-[#5EAFF9]/10 size-full md:size-auto pb-10">
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3 md:gap-10">
