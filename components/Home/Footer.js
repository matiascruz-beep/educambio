...
export default function Footer ({}) {
    return (
        ...
        <div class="mx-[25rem] grid grid-cols-3 grid-flow-col gap-5">
            <div class="p-5">
                <h2 class="mb-10 text-2xl font-poppins tracking-[0.5rem]">EDUCAMBIO</h2>
                <p class="mb-[6rem] font-light">Una educación secundaria sólida puede abrir puertas a futuras oportunidades.</p>
                <div class="mt-4 flex gap-8">
                    <a href="https://www.facebook.com/" target="_blank">
                        <svg class="w-5 h-5 stroke-current hover:text-blue-500" viewBox="0 0 13 21" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://x.com/" target="_blank">
                        <svg class="w-6 h-6 stroke-current hover:text-blue-500" viewBox="0 0 26 19" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://www.instagram.com/" target="_blank">
                        <svg class="w-6 h-6 stroke-current hover:text-blue-500" viewBox="0 0 24 22" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="p-5 flex flex-col space-y-2 md:justify-self-center">
                <a href="#" class="hover:underline">Home</a>
                <a href="#" class="hover:underline">Nosotros</a>
                <a href="#" class="hover:underline">Alumnos</a>
            ...
            <div class="p-5">
                <form action="#" method="POST" class="mx-auto max-w-xl">
                    <div class="grid grid-cols-1 gap-x-2 gap-y-1 sm:grid-cols-2">
                        ...
                        <div class="mt-2.5">
                          <input type="text" name="nombre" id="nombre" placeholder="Nombre*" class="block w-full rounded-md border-0 px-3.5 py-2 bg-[#FBF8EE] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                        </div>

                        <div class="mt-2.5">
                          <input type="text" name="apellido" id="apellido" placeholder="Apellido*" class="block w-full rounded-md border-0 px-3.5 py-2 bg-[#FBF8EE] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                        </div>

                        <div class="mt-2.5">
                          <input type="email" name="email" id="email" placeholder="Correo electronico*" class="block w-full rounded-md border-0 px-3.5 py-2 bg-[#FBF8EE] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                        </div>

                        <div class="mt-2.5">
                          <input type="tel" name="telefono" id="telefono" placeholder="Telefono*" class="block w-full rounded-md border-0 px-3.5 py-2 bg-[#FBF8EE] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
                        </div>

                      <div class="sm:col-span-2">
                        <div class="mt-2.5">
                          <textarea name="mensaje" id="mensaje" placeholder="Mensaje*" rows="4" class="block w-full rounded-md border-0 px-3.5 py-2 bg-[#FBF8EE] text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                        </div>
                      </div>

                    </div>
                    <div class="mt-2.5 text-center">
                      <button type="submit" class="w-40 rounded-3xl bg-[#0063C7] px-1 py-2.5 text-center text-base md:font-bold font-poppins text-white shadow-sm hover:bg-blue-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">CONTACTANOS</button>
                    </div>
                  </form>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 gap-10 py-5 md:grid-cols-2">
            <p class="mr-2 text-xs text-slate-600 text-end font-poppins">© EDUCAMBIO 2024 - Todos los derechos reservados.</p>
            <div class="ml-2 flex items-center space-x-4 text-xs font-poppins text-slate-600 ">
