...
export default function Welcome({name, tematic, content, date, hour, student, image}) {
    return (
       ...
       <div className="grid-flow-col grid-cols-2">
            ...
            <table className="mt-16 w-full text-white border-separate border-spacing-y-4">
            <thead className="bg-[#0063C7] ">
                <tr>
                    <th className="text-center px-2.5 h-[95px] uppercase rounded-tl-[20px] rounded-bl-[20px]">Materia</th>
                    ...
                    <th className="text-center px-2.5 h-[95px] uppercase">Estudiantes</th>
                    <th className="text-center px-2.5 h-[95px] uppercase rounded-tr-[20px] rounded-br-[20px]">Acciones</th>
                </tr>
            </thead>
            <tbody>
